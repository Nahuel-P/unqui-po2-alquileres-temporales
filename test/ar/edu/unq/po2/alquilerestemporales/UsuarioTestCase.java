...
class UsuarioTestCase {
	...
	void setUp() throws Exception {
		this.nombreYApellidoDeUsuario = "Pepito G�mez";
		this.direccion = "Calle Falsa 123";
		this.telefono = "123654789";
		this.fechaDeAlta = LocalDate.now();
		this.nombreYApellidoDeUsuario2 = "Pepita G�mez";
		...
		comentarioCalificacionMedia = "Propietario normal, me dej� las llaves y se fue.";
